...
**Bẫy.** Nghĩ dùng một câu lệnh SQL duy nhất luôn tránh được mọi anomaly ở Read Committed. Sách chỉ ra một ngoại lệ tinh quái: nếu câu lệnh gọi một hàm \`VOLATILE\` chạy truy vấn lồng nhau, hàm đó có thể thấy dữ liệu không nhất quán với phần còn lại của câu lệnh chính. Bẫy thứ hai: nghĩ Repeatable Read loại bỏ hoàn toàn nguy cơ đọc sai. Sách chứng minh bằng ví dụ tính lãi rằng snapshot isolation (nền của Repeatable Read) chỉ không ngăn được đúng hai anomaly — write skew và anomaly transaction chỉ đọc — bất kể còn bao nhiêu anomaly khác chưa biết.
