...
export const fieldGuides = {
  ...
  jpa: {
    ...
    steps: [
      ...
      { id: "jp-6", title: "Tự phỏng vấn: kiểm tra mình đứng ở tầng nào", desc: "Trả lời thành lời trước khi lật đáp án mẫu. Đọc hiểu và nói ra được là hai việc khác nhau — chính chỗ này tách người đã hiểu khỏi người mới đọc qua. Bảng tổng kết chia theo bốn cấp cho biết bạn rụng ở tầng nào.", href: "#/interview", done: { kind: "interview", seenPct: 50, passPct: 70 } },
    ],
    method: [
