...
**Đọc.** [§13.1 Bức tranh toàn cảnh về OAuth 2 và OpenID Connect](#/docs/springsec-13) — phép ẩn dụ buổi phỏng vấn ở đầu mục, rồi bốn thực thể và luồng bảy bước ngay sau đó. Tiếp [§13.2 Các cách thức triển khai token](#/docs/springsec-13) cùng hai mục con [§13.2.1 Sử dụng opaque token](#/docs/springsec-13) và [§13.2.2 Sử dụng non-opaque token](#/docs/springsec-13) — nhớ ba phần của một JWT và cách chúng được nối lại bằng dấu chấm.
