...
**Đọc.** Chương 14 chỉ khoảng 10,5 nghìn từ, đọc trọn một buổi. [Predictive Analytics](#/docs/ddia-14): đọc kỹ cả ba mục con, mỗi mục một dạng hại — [Bias and Discrimination](#/docs/ddia-14): đầu vào thiên lệch không thể cho đầu ra công bằng; [Responsibility and Accountability](#/docs/ddia-14) đối chiếu điểm tín dụng, hỏi "bạn đã làm gì" và sửa được, với dự đoán hỏi "ai giống bạn", không cho khiếu nại; [Feedback Loops](#/docs/ddia-14) là vòng xoáy tín dụng, thất nghiệp, nghèo đói. Trong [Privacy and Tracking](#/docs/ddia-14), đọc kỹ mạch giám sát–đồng ý — [Surveillance](#/docs/ddia-14), [Consent and Freedom of Choice](#/docs/ddia-14) — nền khối Bẫy, cùng [Quyền riêng tư và việc sử dụng dữ liệu](#/docs/ddia-14) cho privacy là quyền quyết định và [Luật pháp và tự điều chỉnh](#/docs/ddia-14) cho data minimization; hai mục về quyền lực dữ liệu và Cách mạng Công nghiệp: lướt. Rồi [Tóm tắt](#/docs/ddia-14).
