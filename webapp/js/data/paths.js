...
export const PATHS = {
  ...
  java: {
    label: "Java Backend",
    icon: "☕",
    desc: "Một nghề, năm chặng: Spring cơ bản → Java hiện đại → khả năng mở rộng trên Tomcat → concurrency sau Loom → bảo mật. Lập trình hệ thống là nền tuỳ chọn cho ai muốn hiểu tới tầng kernel.",
