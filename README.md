...
│   ├── sysprog/ · modern-java/ · effective-java/ · wgjd/ · jcip/ · ocnj/ · jpa/ · ddia/ · kafka/
│   └── modern-concurrency/ · spring-start/ · spring-security/ · senior-java/
...
Ngoài mảng Java, repo còn chứa bộ tài liệu luyện thi **CKAD/CKA/CKS**, bản dịch **System Programming Coursebook**, bản dịch **Kubernetes in Action**, bản dịch **CKA Study Guide**, bản dịch **Kubernetes: Up and Running**, bản dịch **Modern Java in Action**, bản dịch **Effective Java**, bản dịch **The Well-Grounded Java Developer**, bản dịch **Java Concurrency in Practice**, bản dịch **Optimizing Cloud Native Java**, bản dịch **Java Persistence with Spring Data and Hibernate**, bản dịch **Designing Data-Intensive Applications**, bản dịch **PostgreSQL 14 Internals**, bản dịch **Kafka: The Definitive Guide**, bản dịch **Modern Concurrency in Java**, bản dịch **Spring Start Here**, bản dịch **Spring Security in Action**, **Lộ trình Senior Java** (chương trình tự học 24 tháng), **pet project FlashSale** (dự án thực chiến 24 tuần) và web app **DevPrep** để học/ôn tập/thi thử cả mười bảy lĩnh vực:
...
| [`sources/kubernetes/kubernetes-in-action/`](./sources/kubernetes/kubernetes-in-action/) | Bản dịch tiếng Việt *Kubernetes in Action*, ấn bản 2 (Marko Lukša, Manning) — sách có bản quyền thương mại, không phải giấy phép mở như CC BY 4.0. 18 chương, 204 hình. Đọc trong app ở lĩnh vực Kubernetes. |
...
| [`sources/spring-security/`](./sources/spring-security/) | Bản dịch tiếng Việt *Spring Security in Action*, ấn bản 2 (Laurentiu Spilca, Manning) — sách có bản quyền thương mại, không phải giấy phép mở như CC BY 4.0. 17 chương (2–18), 142 hình. Đọc trong app ở lĩnh vực Spring Security, kèm lộ trình đọc 9 tuần. |
| [`sources/senior-java/`](./sources/senior-java/) | Kế hoạch tự học 24 tháng từ Mid-level lên Senior Java + DevOps: 4 giai đoạn (Java/Spring, DevOps, K8s/Cloud, System Design) + hướng dẫn học với kho tài nguyên, 6 tài liệu. Đọc trong app ở lĩnh vực Lộ trình Senior Java, kèm ma trận năng lực 96 tiêu chí. |
...
| [`sources/effective-java/`](./sources/effective-java/) | Bản dịch tiếng Việt *Effective Java*, ấn bản 3 (Joshua Bloch — Addison-Wesley 2018) — sách có bản quyền thương mại, không phải giấy phép mở như CC BY 4.0. 11 chương (2–12), đủ 90 Item, không có hình. Đọc trong app ở lĩnh vực Effective Java, kèm lộ trình đọc 10 tuần. |
| [`webapp/`](./webapp/) | **DevPrep** — web app học tập đa lĩnh vực (17 lĩnh vực): **bốn con đường học** (Kubernetes & Cloud · Java Backend · Data & Distributed · Dự án thực chiến) bao trên 17 lĩnh vực, **Hướng dẫn học** cho từng lĩnh vực / track / tài liệu, thư viện theo sách → Phần, lộ trình tương tác (29 giáo trình, 1251 mục), thư viện tài liệu (311 tài liệu, đánh dấu đã đọc), ma trận năng lực (96 tiêu chí), flashcards spaced repetition (174 thẻ), trắc nghiệm (220 câu), thi thử bấm giờ, 22 labs, tra cứu kubectl, tìm kiếm toàn cục không dấu, xuất/nhập tiến độ. Không cần build, không dependency. Chi tiết: [`webapp/README.md`](./webapp/README.md). |
