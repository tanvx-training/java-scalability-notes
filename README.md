...
│   ├── sysprog/ · modern-java/ · wgjd/ · jcip/ · ocnj/ · jpa/ · ddia/ · kafka/ · modern-concurrency/
...
| [`webapp/`](./webapp/) | **DevPrep** — web app học tập đa lĩnh vực (14 lĩnh vực): **ba con đường học** (Kubernetes & Cloud · Java Backend · Data & Distributed) bao trên 14 lĩnh vực, **Hướng dẫn học** cho từng lĩnh vực / track / tài liệu, thư viện theo sách → Phần, lộ trình tương tác (21 giáo trình, 998 mục), thư viện tài liệu (259 tài liệu, đánh dấu đã đọc), ma trận năng lực (96 tiêu chí), flashcards spaced repetition (174 thẻ), trắc nghiệm (220 câu), thi thử bấm giờ, 22 labs, tra cứu kubectl, tìm kiếm toàn cục không dấu, xuất/nhập tiến độ. Không cần build, không dependency. Chi tiết: [`webapp/README.md`](./webapp/README.md). |
