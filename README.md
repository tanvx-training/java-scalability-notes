...
| [`webapp/`](./webapp/) | **DevPrep** — web app học tập đa lĩnh vực (15 lĩnh vực): **ba con đường học** (Kubernetes & Cloud · Java Backend · Data & Distributed) bao trên 15 lĩnh vực, **Hướng dẫn học** cho từng lĩnh vực / track / tài liệu, thư viện theo sách → Phần, lộ trình tương tác (22 giáo trình, 1038 mục), thư viện tài liệu (270 tài liệu, đánh dấu đã đọc), ma trận năng lực (96 tiêu chí), flashcards spaced repetition (174 thẻ), trắc nghiệm (220 câu), thi thử bấm giờ, 22 labs, tra cứu kubectl, tìm kiếm toàn cục không dấu, xuất/nhập tiến độ. Không cần build, không dependency. Chi tiết: [`webapp/README.md`](./webapp/README.md). |
