...
|---|---|---|---|---|
| API nội bộ ít client, gọi qua LB có pool riêng | 1000–2000 | 100 | tính theo [07](07-threadpool-sizing.md)) | Client là vài chục instance service khác, connection tái sử dụng mạnh |
| API public nhiều client mobile | 8192 (giữ mặc định) | 200–500 | tính theo [07](07-threadpool-sizing.md)) | Nhiều connection idle keep-alive, mỗi connection ít request |
...
**Tài liệu liên quan:** [02 — Timeouts & Exceptions](02-timeouts-and-exceptions.md) · [06 — TaskQueue internals](06-tomcat-threadpool-taskqueue.md)) · [07 — Thread pool sizing](07-threadpool-sizing.md))
