...
**Tài liệu liên quan:** [01 — Connection flow](01-connection-request-flow.md) · [04 — Vì sao thread chờ DB vẫn RUNNABLE](04-java-thread-lifecycle.md)) · [06 — TaskQueue & back-pressure](06-tomcat-threadpool-taskqueue.md))
